...
export default function AddEditPartPage() {
  ...
  const {
    ...
    handleSubmit,
    resetForm,
  } = usePartForm(id, null); // Pass id as first parameter, null as second

  // The usePartForm hook handles loading part data internally
  ...
  // Show loading state while the hook is fetching part data in edit mode
  ...
  return (
    <div className="p-4 w-full max-w-none">
      ...
      {/* Show error if part data failed to load in edit mode */}
      {isEditMode && submitError && submitError.includes('load part data') && (
        <div className="mb-4">
          <button
